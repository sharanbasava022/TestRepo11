...
public class NwDmTest01 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new MehpyLoginPage(driver).username,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new MehpyLoginPage(driver).password,"Opal@1234");
