...
package NwDmModule.NwDmFeature1;
import pom.MehpyLoginPage;
import java.io.File;
...
public class NwTest06 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL(actions.getData("./Excel/UserData.xlsx","Sheet1",1,2));
        ...
        try
        {
            actions.EnterData(new MehpyLoginPage(driver).username,actions.getData("./Excel/UserData.xlsx","Sheet1",1,0));
        ...
        try
        {
            actions.EnterData(new MehpyLoginPage(driver).password,actions.getData("./Excel/UserData.xlsx","Sheet1",1,1));
        ...
        try
        {
            actions.Click(new MehpyLoginPage(driver).login);
